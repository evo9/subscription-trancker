...
# Create migration
docker compose exec api php artisan make:migration create_payments_table --no-interaction

# Create seeder
docker compose exec api php artisan make:seeder PaymentSeeder --no-interaction

# Create factory
docker compose exec api php artisan make:factory PaymentFactory --no-interaction
...
| Index strategy | frontend (apps/web) | Backup strategy |
