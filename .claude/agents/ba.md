...
- Identify affected components: models, controllers, services, APIs, database
  schema, frontend (apps/web), background jobs
...
- Specify frontend components and user interactions (Next.js/React, apps/web)
...
[Next.js/React components, pages, forms, state management (apps/web)]
...
| Tool | When to Use |
|------|-------------|
| `search-docs` | Laravel documentation for feasibility |
...
| Roadmaps | API endpoints | Coverage analysis |
...
- Reference Laravel and project-specific patterns from CLAUDE.md
  when available
